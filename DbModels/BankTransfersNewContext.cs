...
public partial class BankTransfersNewContext : DbContext
{
    public BankTransfersNewContext()
    {
    }

    public BankTransfersNewContext(DbContextOptions<BankTransfersNewContext> options)
        : base(options)
    {
    }
